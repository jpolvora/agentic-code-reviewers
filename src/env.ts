...
export const env = {
  ...
  opencodeServerLog: () => readEnv('OPENCODE_SERVER_LOG', 'CURSOR_REVIEWER_OPENCODE_SERVER_LOG'),
  opencodeLogLevel: () => readEnv('OPENCODE_LOG_LEVEL', 'CURSOR_REVIEWER_OPENCODE_LOG_LEVEL'),
