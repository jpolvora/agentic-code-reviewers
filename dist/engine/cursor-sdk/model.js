...
const defaultLister = (options) => Cursor.models.list({ apiKey: options?.apiKey });
/**
 ...
 */
export function resolveCursorModelShape(modelId) {
 ...
 */
export async function validateCursorModelId(modelId, lister = defaultLister, options) {
    ...
    try {
        ...
        throw new ModelCatalogError('cursor-sdk', `${cause}. Verifique CURSOR_API_KEY, rede e acesso à API de modelos.`);
    }
